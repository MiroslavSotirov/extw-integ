...
public class VgsConnectorServiceTest {
  static final String OPERATOR_CODE = Constant.OPERATOR_VGS;
  static final String LAUNCH_TOKEN = VgsDispatcher.TOKEN_2976012;
  static final String TOKEN = VgsDispatcher.TOKEN_2976012;
  ...
  public void initQuarkusTest() {
    companyId =
        configuration.configuration(OPERATOR_CODE, VgsConfiguration.class).getDefaultCompanyId();
  }
  ...
  public void testHash() {
    ...
    assertThat(computedHash, is("ad3448341788a690e6768af9fee6dfc4"));
  }
