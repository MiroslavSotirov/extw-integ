...
public class PariMatchConnectorServiceTest {
  static final String OPERATOR_CODE = Constant.OPERATOR_PARIMATCH;
  static final String LAUNCH_TOKEN = PariMatchDispatcher.LAUNCH_TOKEN_2976012;
  ...
  public void initQuarkusTest() {
    companyId =
        configuration
            .configuration(OPERATOR_CODE, PariMatchConfiguration.class)
            .getDefaultCompanyId();
  }
